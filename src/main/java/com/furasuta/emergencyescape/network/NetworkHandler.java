...
public class NetworkHandler {
    ...
    public static void register() {
        ...
        CHANNEL.messageBuilder(SyncModelPartPacket.class, NetworkDirection.PLAY_TO_SERVER)
                .encoder(SyncModelPartPacket::encode)
                .decoder(SyncModelPartPacket::decode)
                .consumerMainThread(SyncModelPartPacket::handle)
                .add();
    }
}
